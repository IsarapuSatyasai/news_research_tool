...
```bash
  git clone https://github.com/IsarapuSatyasai/news_research_tool.git
```
...
- One can now ask a question and get the answer based on the news articles we provide.
- Use these news article to test the project.
